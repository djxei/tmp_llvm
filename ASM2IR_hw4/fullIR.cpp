...
void FullIR::buildIR(Binary &Bin) {
  ...
  Type *int32x3Types[] = {int32Type, int32Type, int32Type};
  ...
  Value *sp = builder.CreateAlloca(int32Type);
  builder.CreateStore(builder.getInt32(CPU::RegSize), sp);
...
bool FullIR::printIR(std::string FileName, std::string &ErrorMsg) {
  ...
  Type *simPutPixelParamTypes[] = {int32Type, int32Type, int32Type};
